    ...
    <div className='container px-4'>
      <div className="row d-flex justify-content-between ">
        <div className="col-lg-2 col-md-4 col-sm-6 footer-sub-content-div">
          <div>
            <h1>ClipCart</h1>
            <p id='footer-p'>Whether you're a trendsetter, a minimalist, or an adventurer at heart, Mixtas has something for everyone. Our diverse range of styles caters to various personas. </p>
          </div>
        </div>
        {/* About us */}
        <div className="col-lg-2 col-md-4 col-sm-6 footer-sub-content-div"><div>
          <h3>About Us</h3>
          <ul>
          ...
          <li className="dropdown-item px-0">Sustainability and Efforts</li>
        ...
        <div className="col-lg-2 col-md-4 col-sm-6 footer-sub-content-div">
          ...
          <h3>Accessibility</h3>
          <ul>
          <li className="dropdown-item px-0">Accessibility Statement</li>
          <li className="dropdown-item px-0">Site & Map</li>
          <li className="dropdown-item px-0">Web Accessibility Option</li>
     ...
     {/* Community */}
        ...
        <div className="col-lg-2 col-md-4 col-sm-6 footer-sub-content-div"><div>
          ...
          <button id='footer-eamil-button' className='btn'>Enter your E-mail</button>
          </div>
          </div>
      </div>
      {/* copy rights */}
      ...
      <div className='container'>
            &copy; 2025 ClipCart All rights recived
      </div>
    </div>
    </>
  )
