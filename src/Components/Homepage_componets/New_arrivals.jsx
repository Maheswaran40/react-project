      ...
      <div className="container">
        ...
        >
          <div id="offerdiv">
            {" "}
            <h1>
              Trending Collection with{" "}
              <span style={{ color: "#E52020" }}>50%</span>Offer
            </h1>{" "}
            <button
              className="btn btn-dark text-white position-absolute "
        ...
        <div className="row d-flex m-0 pt-2 justify-content-between">
          ...
          >
            {" "}
            <div id="offerdiv-sub1">
              {" "}
              <h3>
                Torust Bags with <span style={{ color: "#E52020" }}>30%</span>
                Offer
              </h3>{" "}
              <button
                className="btn btn-dark text-white position-absolute "
          ...
          >
            <div id="offerdiv-sub2">
              {" "}
              <h3>
                Trending tops with <span style={{ color: "#E52020" }}>20%</span>
                Offer
              </h3>{" "}
              <button
                className="btn btn-dark text-white position-absolute "
        ...
        {/* heroimg end*/}
        <br />
        <h1 className="text-center" style={{ color: "#A89C29" }}>
          New Arrivals
        </h1>
        <div className="row">
          {/* new alrivals mapping start*/}
          {all_product
            .filter((value) => value.catagery === "new arrival")
            .map((value, index) => {
              return (
        ...
        <div>
          <center style={{ color: "gray", fontSize: "large" }}>
            Top Brands
          </center>
          <center>
            <h1 style={{ color: "var(--graygreen)" }}>Popular Brands</h1>
          </center>
        </div>
        <br />
        <div>
