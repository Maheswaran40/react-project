        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-12 my-2 ">
            <div className="card border-0">
              ...
              <div className="card-body">
                <center>
                  <h3 style={{ color: "#FBA518" }}>Address</h3>
                  <p>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 my-2 ">
            <div className="card border-0">
              ...
              <div className="card-body">
                <center>
                  <h3 style={{ color: "#FBA518" }}>Phone</h3>
                  <p>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 my-2 ">
            <div className="card border-0">
              ...
              <div className="card-body">
                <center>
                  <h3 style={{ color: "#FBA518" }}>Mail</h3>
                  <p>
                    Sent mail to <br />
                    support@clipcart.com
                  </p>
                </center>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 my-2 ">
            <div className="card border-0">
              ...
              <div className="card-body">
                <center>
                  <h3 style={{ color: "#FBA518" }}>Live connection</h3>
                  <p>
