...
import { shirt_hero } from '../../assets/images';
    ...
    <>
      ...
      <div>
        <Swiper
          ...
          loop
        >
          {shirt_hero.map((value, index) => {
              return (
                <SwiperSlide>
                  <div id="shoes-banner" className="px-2" key={index}>
                    <img src={value.img} alt="image" /> <br />
                  </div>
                </SwiperSlide>
              );
            })}
      ...
      <div className="border" id="shoe-main">
        <div id="shoe-sub-1" style={{height:"700px"}}>
          <div id="filter-price">
            <h4>Price</h4>
            <span className="bg-white p-1 border rounded-3">{rangevalue}</span>
          </div>
        ...
        {/* product div */}
        <div id="shoe-sub-2" style={{height:"700px"}} className="container row">
          {productList
            .filter(
              (value) =>
                value.folder === "shirts" &&
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >   <b>
                            <span style={{ textDecoration: "line-through" }}>₹{value.dashprice.toLocaleString("en-IN")}
                            </span>
                          </b>
                          <span  style={
          ...
          {selectedId
            ? (() => {
                const filtered = productList.filter((item) => {
                  if (item.folder !== "shirts") return false;
                  if (
                    !(
