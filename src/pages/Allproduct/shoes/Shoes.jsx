  ...
  return (
    <>
      <div>
        ...
        >
          {productList
            .filter((value) => value.category === "shoe_card")
            .map((value, index) => {
              return (
                <SwiperSlide>
      ...
      <div>
        ...
        >
          {productList
            .filter(
              (value) =>
                value.category === "banner" && value.folder === "shoes_header"
            )
            .map((value, index) => {
              return (
                <SwiperSlide>
      ...
      <br />
      <br />
      <h1 style={{ textAlign: "center", color: "blue" }}>Available product</h1>
      {/* filter tab */}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="pricedetails-sub"
                        >
                          <b>
          ...
          {selectedId
            ? (() => {
                const filtered = productList.filter((item) => {
                  if (item.folder !== "shoes") return false;
                  if (
                    !(
                ...
                return filtered.map((value, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className="card-body d-flex align-items-center justify-content-center shoe-img-wrapper"
                          style={{ cursor: "pointer" }}
                        >
                          <img
                            src={value.url}
